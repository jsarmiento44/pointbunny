...
})({"c4XJu":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "6ce807893b63cdc7";
"use strict";
...
},{}],"iKfhs":[function(require,module,exports,__globalThis) {
...
class NewOrderView extends (0, _viewJsDefault.default) {
    ...
    <div class="modal-overlay" id="newOrderModal">
      <div class="modal-content">
        ...
        ${this._data.map((menu)=>`<div class="menu-category-header">${menu.category}</div>
        ...
        <div class="modal-right">
          ...
          <div id="cartItems" style="display:flex; flex-direction:column; gap:12px; max-height:60vh; overflow-y:auto;">
            <div style="display:flex; justify-content:space-between;">
              ...
              <span>\u{20B1}120</span>
            </div>
            <div style="display:flex; justify-content:space-between;">
              <span>Latte x2</span>
              <span>\u{20B1}300</span>
            </div>
          </div>
  ...
  `;
    ...
    _toggleCloseModal() {
        this._parentElement.addEventListener("click", function(e) {
            ...
            if (!btn) return;
            if (btn) document.querySelector(".modal-overlay").classList.add("hidden");
        });
    }
    _addToCart(handler) {
        this._parentElement.addEventListener("click", function(e) {
...
`;
        document.querySelector(".modal-parent").insertAdjacentHTML("afterend", markup);
    }
}
exports.default = new NewOrderView();

},{"./view.js":"j6ZzV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["c4XJu","iKfhs"], "iKfhs", "parcelRequireae58", {})

//# sourceMappingURL=Pointy.3b63cdc7.js.map
