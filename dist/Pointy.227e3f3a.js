...
})({"3BOVN":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "6736cd56227e3f3a";
"use strict";
...
},{}],"l5McU":[function(require,module,exports,__globalThis) {
"use strict";
// DOM ready helper
function onReady(fn) {
...
onReady(function() {
    ...
    if (document.body.className.indexOf("js") === -1) document.body.className += (document.body.className ? " " : "") + "js";
    /* ========= Reveal-on-scroll ========= */ if ("IntersectionObserver" in window) {
    ...
    /* ========= THEME (simple & bullet-proof) ========= */ var prefersReduced = false;
    try {
    ...
    function wireTheme() {
        ...
        for(var i = 0; i < tTargets.length; i++)(function(el) {
            el.addEventListener("click", function() {
                applyTheme(el.getAttribute("data-theme-target"));
            });
        })(tTargets[i]);
        var tToggles = document.querySelectorAll("[data-theme-toggle]");
        for(var k = 0; k < tToggles.length; k++)tToggles[k].addEventListener("click", function() {
            toggleTheme();
        });
    ...
    /* ========= Bokeh background (perf-friendly, ES5) ========= */ (function() {
        try {
            ...
            function spawn() {
                particles.length = 0;
                var count = 28, width = canvas.width / dpr, height = canvas.height / dpr;
                for(var i = 0; i < count; i++){
                    var r = rand(18, 64), sp = rand(0.06, 0.25), ang = Math.random() * Math.PI * 2;
...
},{}]},["3BOVN","l5McU"], "l5McU", "parcelRequireae58", {})

//# sourceMappingURL=Pointy.227e3f3a.js.map
